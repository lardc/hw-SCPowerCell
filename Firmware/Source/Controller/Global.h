...
//------------------------------------------------
#define FLAG_RESET_FOR_PROG				0xFFFF1111								//Значение флага при перезагрузке процессора с последующим перепрограммированием
#define FLAG_RESET						0x3333									//Значение флага при перезагрузке процессора без перепрограммирования
//------------------------------------------------
