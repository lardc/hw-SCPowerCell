...
//регистры для версии 1.1
#define REG_SC_PULSE_COEF                       4                               //Калибровочный коэффициент амплитуды импульса ударного тока
#define REG_REGULATOR_OFFSET_VAR                5                               //Коэффициент изменения значения REGULATOR_OFFSET_VALUE, от амплитуды импульса тока
//регистры для версии 2.0
...
#define REG_CFG_NODE_ID							12								// Настройка CAN NodeID
//---------------
...
#define ERR_BUFFER_OVERFLOW						4								// В блоке версии 2.0 размер буфера данных превышает максимальный размер буфера
